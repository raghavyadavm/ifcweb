          ...
          if (jsonData[key].hasOwnProperty(innerkey)) {
            ...
            alarmList.forEach(element => {
              if (((jsonData[key])[innerkey]).includes(element)) {
                ...
                // document.getElementById("maintainance-div").children[1].innerHTML += "<li class='list-group-item'>" + x + " : " + (jsonData[key])[x] + "</li>";
                // document.getElementById("maintainance-div").children[1].innerHTML += "<li class='list-group-item'>" + s + "</li>";
              }
            });
          }
        }
